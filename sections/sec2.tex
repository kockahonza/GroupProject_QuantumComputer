...
There are many methods of creating well defined qubits, however scalability and producing multiple which remain in a superposition state is challenging - up to millions of qubits are required for most quantum algorithms. \cite{bergou_quantum_2021} (is this right?)
