...
This incredible processing power makes quantum computers ideal at solving many other combinatorics based problems, where finding the solution involves trying a vast number of possibilities.
...
\end{itemize}
There are multiple approaches to building a quantum computer with no single method becoming the leading approach.
...
Optical qubits currently have some large hurdles to overcome - as will be discussed in section [hereee] however once these are overcome it is likely to be an attractive attender for future quantum computing and information transfer.
